...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "malvin~xn8iCR6A#iU7Bu7yUBtM8e0YLiD-gag9DW6IVuLfRQ0gPFZOgG1A",
// add your Session Id make sure it starts with malvin~
PREFIX: process.env.PREFIX || ".",
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "𝐀𝐇𝐌𝐄𝐃-xᴅ",
...
// add img for alive msg
        ...
        LIVE_MSG: process.env.LIVE_MSG || "> ʙᴏᴛ ɪs sᴘᴀʀᴋɪɴɢ ᴀᴄᴛɪᴠᴇ ᴀɴᴅ ᴀʟɪᴠᴇ\n\n\nᴋᴇᴇᴘ ᴜsɪɴɢ ✦ᴍᴀʟᴠɪɴ xᴅ✦ ғʀᴏᴍ 𝐦𝐚𝐥𝐯𝐢𝐧𝐀𝐇𝐌𝐄𝐃 ᴛᴇᴄʜ ɪɴᴄ⚡\n\n\n*© ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ - ᴍᴅ\n\n> ɢɪᴛʜᴜʙ :* github.com/XdKing2/MALVIN-XD",
// add alive msg here 


        STICKER_NAME: process.env.STICKER_NAME || "𝐀𝐇𝐌𝐄𝐃-xᴅ",
